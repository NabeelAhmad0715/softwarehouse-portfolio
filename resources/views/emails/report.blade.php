...
<head>
    ...
    <title>Welcome to Archiace</title>
            ...
            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                ...
                <tr>
                    <td height="10" style="font-size: 10px; line-height: 10px;">&nbsp;
                        <h4 style="margin-bottom:20px;font-size:20px;"><b>Name:</b> {{ $report->user->name }}</h4>
                    </td>
                </tr>
                <tr>
                <td height="10" style="font-size: 10px; line-height: 10px;">&nbsp;
                    <h4 style="margin-bottom:20px;font-size:20px;"><b>Email:</b> {{ $report->user->email }}</h4>
                </td>
                </tr>
                <tr>
                <td height="10" style="font-size: 10px; line-height: 10px;">&nbsp;
                    <h4 style="margin-bottom:20px;font-size:20px;"><b>Vehicle Number:</b> {{ $data['vehicleNumber'] }}</h4>
                </td>
                </tr>
                <tr>
                    <td align="center">
                            ...
                            <tr>
                                <td
                                    ...
                                    <div style="line-height: 24px">
                                        <h5>Hello, Please download your report in the attachment</h5>
                                    </div>
                                    </div>
                                </td>
                            </tr>
