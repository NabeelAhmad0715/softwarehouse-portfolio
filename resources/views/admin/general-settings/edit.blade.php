            ...
            <div class="col-md-12">
                ...
                <div class="card card-table">
                    <div class="card-header">
                        <h4 class="card-title">General Setings</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row form-row">
                                        ...
                                        <div class="change-avatar">
                                            <div class="profile-img" style="margin-bottom:20px;">
                                                @if ($generalSettings->site_logo)
                                                    <img height="150" src="{{ asset('/storage/' . $generalSettings->site_logo ) }}" alt="User Image">
                                                @endif
                                            </div>
                                        ...
                                        <div class="change-avatar">
                                            <div class="profile-img" style="margin-bottom:20px;">
                                                @if ($generalSettings->favicon_icon)
                                                    <img height="150" src="{{ asset('/storage/' . $generalSettings->favicon_icon) }}" alt="User Image">
                                                @endif
                                            </div>
                                            <div class="upload-img">
                                                <div class="change-photo-btn">
                                                    <span><i class="fa fa-upload"></i> Upload Favicon Icon</span>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $generalSettings->site_name }}" name="site_name" required >
                                    </div>
                                </div>
                                @error('site_name')
                                    <span class="form-text text-danger">{{ $message }}</span>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" value="{{ $generalSettings->admin_email }}" class="form-control" name="admin_email" required >
                                    </div>
                                </div>
                                @error('admin_email')
                                    <span class="form-text text-danger">{{ $message }}</span>
                        ...
                        <div class="page-header">
                            <div class="row">
                                <div class="col-sm-7 col-auto">
                                    <h3 class="page-title">Edit General Settings</h3>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="change-avatar">
                                                            <div class="profile-img">
                                                                @if ($generalSettings->site_logo)
                                                                    <img src="{{ asset('/storage/' . $generalSettings->site_logo ) }}" alt="User Image">
                                                                @endif
                                                            </div>
                                                            <div class="upload-img">
                                                                <div class="change-photo-btn">
                                                ...
                                                <div class="col-12 col-md-12">
                                                    <div class="form-group">
                                                        <div class="change-avatar">
                                                            <div class="profile-img">
                                                                @if ($generalSettings->favicon_icon)
                                                                    <img src="{{ asset('/storage/' . $generalSettings->favicon_icon) }}" alt="User Image">
                                                                @endif
                                                            </div>
                                                            <div class="upload-img">
                                                                <div class="change-photo-btn">
