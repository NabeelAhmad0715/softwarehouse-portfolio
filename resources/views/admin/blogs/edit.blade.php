            ...
            <div class="col-md-12">
                <div class="card card-table">
                    <div class="card-header">
                        <h4 class="card-title">Edit Blog - {{ $blog->title }}</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row form-row">
                                        ...
                                        <div class="change-avatar">
                                            <div class="profile-img" style="margin-bottom:20px;">
                                                @if($blog->featured_image)
                                                    <img height="150" src="{{ asset('/storage/' . $blog->featured_image) }}" alt="User featured_image">
                                                @endif
                                            </div>
                                ...
                                <div class="col-6 col-md-6">
                                    <div class="form-group">
                                        <div class="change-avatar">
                                            <div class="profile-img" style="margin-bottom:20px;">
                                                @if($blog->body_image)
                                                    <img height="150" src="{{ asset('/storage/' . $blog->body_image) }}" alt="User body_image">
                                                @endif
                                            </div>
                                            <div class="upload-img">
                                                <div class="change-photo-btn">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="@error('title') border-danger @enderror form-control" name="title" value="{{ old('title', $blog->title) }}" required >
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="@error('meta_title') body-danger @enderror form-control" value="{{ old('meta_title', $blog->meta_title) }}" name="meta_title">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label class="@error('meta_keywords') text-danger @enderror">Meta Keywords</label>
                                        <textarea class="@error('meta_keywords') text-danger @enderror form-control" name="meta_keywords">{{ old('meta_keywords', $blog->meta_keywords) }}</textarea>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label class="@error('meta_description') text-danger @enderror">Meta Description</label>
                                        <textarea class="@error('meta_description') text-danger @enderror form-control" name="meta_description">{{ old('meta_description', $blog->meta_description) }}</textarea>
                                    </div>
                                </div>
                            </div>
