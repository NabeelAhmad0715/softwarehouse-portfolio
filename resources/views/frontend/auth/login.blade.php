...
@section('head')
    <title>Login Panel | Aash Collections</title>
    <meta name="description" content="Aash Collections">
...
<section class="page-section-ptb bg-overlay-white-70 login-signup parallax" style="background: url({{ asset('images/login/07.jpg') }});">
    ...
    @include('common.partials.flash')
     <div class="row no-gutter">
       <div class="col-md-5">
            <div class="login-box-02 bg-overlay-black-70 parallax" style="background: url({{ asset('images/login3.jpg') }});">
